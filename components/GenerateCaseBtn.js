        ...
        <div>
            {loading ? (
                <div role="status">
                    ...
                    <p>AI is generating your case</p>
                </div>
            ) : (
                <Link href="/generateCases">
                    <button
                        disabled={disabled}
                        onClick={handleClick}
                        className="px-10 py-4 shadow-md rounded-full font-bold my-3 hover:shadow-xl active:scale-90 transition duration-150 bg-black text-white"
                    >
